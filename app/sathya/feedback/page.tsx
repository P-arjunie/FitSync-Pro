    ...
    <div className="min-h-screen flex flex-col bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 p-8 flex flex-col">
        <div className="mb-6">
          ...
          <h2 className="text-3xl font-bold mt-2 mb-6">Take Your Feedback To The Next Level</h2>
        </div>
        ...
        <div className="flex-1 flex flex-wrap">
          <div className="w-full md:w-1/2 md:pr-6 flex flex-col">
            <form onSubmit={handleSubmit} className="space-y-6 flex-1 flex flex-col justify-between">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full p-3 bg-gray-800 border border-gray-700 rounded-none focus:outline-none focus:ring-2 focus:ring-red-500 text-white h-36"
                  ...
                  <div className="flex space-x-2">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <span
                        ...
                        className={`cursor-pointer text-4xl ${star <= rating ? 'text-yellow-500' : 'text-gray-700'} hover:text-yellow-400 transition-colors`}
                      >
                        ★
                      </span>
                    ))}
              ...
              <button
                type="submit"
                className="w-full bg-red-600 text-white py-3 font-bold hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition duration-200 flex items-center justify-center mt-8"
                disabled={loading}
              >
                {loading ? (
                  <>
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0 flex flex-col">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 flex-1">
              {[
                {icon: "M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v1h8v-1zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z", title: "Professional Trainers"},
                {icon: "M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.123.489.804.804A1 1 0 0113 18H7a1 1 0 01-.707-1.707l.804-.804L7.22 15H5a2 2 0 01-2-2V5zm5.771 7H5V5h10v7H8.771z", title: "Modern Equipment"},
                {icon: "M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L9 9.414V13a1 1 0 102 0V9.414l1.293 1.293a1 1 0 001.414-1.414z", title: "Results Tracking"}
              ].map((item, idx) => (
            ...
            <div className="mt-8 bg-gray-900 p-4 flex-1">
              ...
              <div className="space-y-4">
                {[
                  {quote: "The trainers at FitSync Pro have completely transformed my fitness journey. Highly recommended!", author: "Alex M."},
                  {quote: "I've seen incredible results in just 3 months. The personalized approach makes all the difference.", author: "Jamie K."}
                ].map((testimonial, idx) => (
