    ...
    <>
      ...
      <header className="header">
        <div className="container">
          ...
          <h1 className="class-title">POWER LIFTING</h1>
          <p className="class-subtitle">Build Maximum Strength & Power</p>
        </div>
      </header>
        ...
        <div className="main-content">
          <div className="class-image-section">
            ...
            <div className="image-overlay">
              <h3>Next Session</h3>
              <div className="schedule-badge">Wednesday | 8:00 PM</div>
            </div>
          </div>
          ...
          <div className="class-details">
            <div className="details-section">
              ...
              <p className="description">
                Master the art of powerlifting with our specialized training program focused on the
                three main lifts: squat, bench press, and deadlift. Build incredible strength and
                power under the guidance of certified powerlifting coaches.
              </p>
            </div>
            ...
            <div className="details-section">
              ...
              <ul className="benefits-list">
                <li>Dramatically increase max strength</li>
                <li>Perfect lifting technique and form</li>
                <li>Build dense muscle mass</li>
                <li>Improve bone density</li>
                <li>Boost confidence and mental toughness</li>
                <li>Competition preparation available</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="class-info">
          <div className="info-grid">
            <div className="info-item">
              ...
              <div className="info-value">75 Minutes</div>
            </div>
            <div className="info-item">
              <div className="info-label">Intensity</div>
              <div className="info-value">Maximum</div>
            </div>
            <div className="info-item">
              <div className="info-label">Equipment</div>
              <div className="info-value">Olympic</div>
            </div>
            <div className="info-item">
              <div className="info-label">Max Capacity</div>
              <div className="info-value">12 People</div>
            </div>
          </div>
        </div>
        ...
        <div className="enrollment-section">
          ...
          >
            {isLoading ? "Loading..." : authUser ? "Enroll Now" : "Login to Enroll"}
              ...
              <ul>
                <li>Unlimited monthly powerlifting classes</li>
                <li>Expert powerlifting coaching</li>
                <li>Olympic equipment access</li>
                <li>Form analysis & correction</li>
...
export default PowerLiftingClassPage;
