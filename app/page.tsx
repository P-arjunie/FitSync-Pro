...
const HomePage: React.FC = () => {
      ...
      try {
        ...
        if (userRole && userEmail && userName && userId) {
          ...
          if (
            ...
            router.push("/user-system-management/admindashboard");
            return;
          }
  ...
  const handleAdminUserManagement = () => {
    router.push("/user-system-management/adminUserManagement");
  };

  const handleUserInfo = () => {
    router.push("/user-system-management/userinfo");
  };
      ...
      if (user.role === "admin") {
        ...
        return (
          <div className="hero-button-container">
            <button
              className="button"
              onClick={() => router.push("/user-system-management/admindashboard")}
            >
              Admin Dashboard
            </button>
        ...
        if (user.role === "member") {
          return (
            <div className="hero-button-container">
              <button
                className="button"
                onClick={() => router.push("/user-system-management/memberdashboard")}
              >
                Member Dashboard
              </button>
              <button className="button" onClick={handleLogout}>
          ...
          return (
            <div className="hero-button-container">
              <button
                className="button"
                onClick={() => router.push("/user-system-management/TrainerProfilePage")}
              >
                Profile
              </button>
              <button className="button" onClick={handleLogout}>
      ...
      <main className="main">
        ...
        <section className="three-card-section">
          ...
          >
            ...
            <Link href="/user-system-management/Authform">
