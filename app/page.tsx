    ...
    <div className="class-item">
      <div className="class-overlay">
        ...
        <div className="overlay-content">
          ...
          <button className="date-button">Monday | 7:00 AM</button>
        </div>
      </div>
      <p className="class-name">Cycling</p> {/* name shown below image by default */}
    </div>
    ...
    <div className="class-item">
      <div className="class-overlay">
        ...
        <div className="overlay-content">
          ...
          <button className="date-button">Tuesday | 6:00 PM</button>
        </div>
      </div>
      <p className="class-name">Workout</p> {/* name shown below image by default */}
    </div>
    ...
    <div className="class-item">
      <div className="class-overlay">
        ...
        <div className="overlay-content">
          ...
          <button className="date-button">Wednesday | 8:00 PM</button>
        </div>
      </div>
      <p className="class-name">Power Lifting</p> {/* name shown below image by default */}
    </div>
    ...
    <div className="class-item">
      <div className="class-overlay">
        ...
        <div className="overlay-content">
          ...
          <button className="date-button">Thursday | 7:00 AM</button>
        </div>
      </div>
      <p className="class-name">Meditation</p> {/* name shown below image by default */}
    </div>
    ...
    <div className="class-item">
      <div className="class-overlay">
        ...
        <div className="overlay-content">
          ...
          <button className="date-button">Friday | 7:30 AM</button>
        </div>
      </div>
      <p className="class-name">Yoga</p> {/* name shown below image by default */}
    </div>
    ...
    <div className="class-item">
      <div className="class-overlay">
        ...
        <div className="overlay-content">
          ...
          <button className="date-button">Saturday | 5:00 PM</button>
        </div>
      </div>
      <p className="class-name">MMA</p> {/* name shown below image by default */}
    </div>
